...
function Footer(){
    return(
        <div className=' h-[30vh] bg-[#e0e0e0] flex relative'>
            <footer>
                <div className="md:items-center md:gap-[80px] flex md:flex-row flex-col md:pt-0 pt-5 mt-[15px] ml-[70px] ">
                    ...
                    <div className="flex flex-col w-[460px] md:pt-0 pt-5 md:gap-[20px] ">
                ...
                <hr className='w-[100%] absolute md:bottom-[30%]  bottom-[15%] bg-gray-500	'></hr>
